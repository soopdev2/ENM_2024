...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet"
              href="Bootstrap2024/assets/css/bootstrap.min.css"/>

        <link href="assets/app/custom/login/login-v3.default.css"
              rel="stylesheet"
              type="text/css" />

        <link href="assets/vendors/general/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.css"
              rel="stylesheet"
              type="text/css" />
        ...
        <link href="assets/vendors/custom/vendors/line-awesome/css/line-awesome.css"
              rel="stylesheet"
              type="text/css" />
        ...
        <link href="assets/vendors/custom/vendors/fontawesome5/css/all.min.css"
              rel="stylesheet"
              type="text/css" />

        <link href="resource/custom.css"
              rel="stylesheet"
              type="text/css" />
        ...
        <script src="assets/soop/js/jquery-3.7.1.js"
        type="text/javascript"></script>

        <script type="text/javascript"
        src="assets/global/scripts/spid-sp-access-button.min.js"></script>

        <link type="text/css"
              rel="stylesheet"
              href="assets/global/css/spid-sp-access-button.min.css" />

        <script src="assets/global/scripts/spid-idps.js"></script>
    ...
    <body class="d-flex flex-column min-vh-100">
                    ...
                    <div class="col-lg-5 col-md-8">
                        ...
                        <div class="it-card-wrapper">
                            ...
                            <div class="it-card">
                                ...
                                <div class="it-card-header text-center">
                                    ...
                                    <img src="resource/demologo.png"
                                         alt="Demo"
                                         height="100"/>

                                    <% } else if (Utility.test) { %>

                                    <img src="resource/beta.png"
                                         alt="Beta"
                                         height="100"/>
                        ...
                        <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto spid-login-container">
                            ...
                            <form class="form w-100"
                                ...
                                <!--
                                    IMPORTANTE:
                                    questo elemento ora è absolute tramite CSS,
                                    quindi quando viene aperto NON aumenta
        ...
        <script src="assets/soop/js/utility.js"
        type="text/javascript"></script>
        ...
        <script type="text/javascript"
        src="assets/soop/js/jquery.fancybox.min.js"></script>

        <script type="text/javascript"
        src="assets/soop/js/fancy.js"></script>

        <script src="assets/vendors/general/bootstrap/dist/js/bootstrap.min.js"
        type="text/javascript"></script>

        <script src="assets/vendors/general/js-cookie/src/js.cookie.js"
        type="text/javascript"></script>

        <script src="assets/soop/js/moment.min.js"
        type="text/javascript"></script>

        <script src="assets/vendors/general/tooltip.js/dist/umd/tooltip.min.js"
        type="text/javascript"></script>

        <script src="assets/vendors/general/jquery-form/dist/jquery.form.min.js"
        type="text/javascript"></script>
        ...
        <script src="assets/app/custom/login/login-general.js"
        type="text/javascript"></script>
