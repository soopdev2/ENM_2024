jQuery && function (t) {
    function i(i, n) {
        ...
        if (i) {
            if (t(i.target).hasClass("spid-idp-button-ignore"))
                return
            i.preventDefault(), i.stopPropagation()
        } else if (d !== n.target && t(n.target).hasClass("spid-idp-button-ignore"))
            return
    ...
    t.extend(t.fn, {spidIDPButton: function (e, n) {
            switch (e) {
                case"show":
