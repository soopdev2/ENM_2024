...
export function localeWeekdaysParse (weekdayName, format, strict) {
    ...
    for (i = 0; i < 7; i++) {
        ...
        if (strict && format === 'dddd' && this._fullWeekdaysParse[i].test(weekdayName)) {
            return i;
        } else if (strict && format === 'ddd' && this._shortWeekdaysParse[i].test(weekdayName)|| strict && format === 'dd' && this._minWeekdaysParse[i].test(weekdayName) || !strict && this._weekdaysParse[i].test(weekdayName)) {
            return i;
        } 
    }
