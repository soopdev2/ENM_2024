...
; (function (global, factory) {
    ...
    function localeMonthsParse(monthName, format, strict) {
        ...
        for (i = 0; i < 12; i++) {
            ...
            // test the regex
            if (strict && format === 'MMMM' && this._longMonthsParse[i].test(monthName)|| strict && format === 'MMM' && this._shortMonthsParse[i].test(monthName) || !strict && this._monthsParse[i].test(monthName)) {
                return i;
            }
        }
    }
    ...
    function parseIso(inp, sign) {
        ...
        var res = inp && parseFloat(inp.replace(/,/g, '.'));
