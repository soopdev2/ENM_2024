            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="mb-3">
                            <h5>
                                <a data-container="body" data-bs-toggle="tooltip" title="TORNA INDIETRO"
                                   href="showModelli.jsp?id=<%=p.getId()%>" class="btn btn-sm btn-light me-2">
                            ...
                            <% if (modify) {%>
                            <form action="<%=request.getContextPath()%>/OperazioniSA" method="POST" target="_blank" class="d-inline">
                        ...
                        <form action="<%=request.getContextPath()%>/OperazioniSA" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <% } else {%>
                                    <span class="fw-bold">
                                        <%=pl1.getDocente().getCognome()%> <%=pl1.getDocente().getNome()%> - <%=pl1.getDocente().getCodicefiscale()%>
                                    </span>
                                    <% } %>
                                </div>
                            </div>
                            ...
                            <!-- ALLIEVI -->
                            <div class="mb-3">
                                <label class="fw-bold text-danger">ALLIEVI</label>
                                <table class="table table-striped table-hover align-middle">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <% if (modify) {%>
                                            <select class="form-select" id="sino_<%=a1.getId()%>" name="sino_<%=a1.getId()%>"
                                                    required onchange="return checkorariomax();">
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <% if (modify) {%>
                                                    <select class="form-select sel-presenza" id="orai_<%=a1.getId()%>" name="orai_<%=a1.getId()%>"
                                                            required onchange="return checkorariomax();">
                                                        <option value="<%=lm.getOrainizio()%>" selected><%=lm.getOrainizio()%></option>
                                                    </select>
                            ...
                            <div class="mb-3 col-xl-4 col-lg-6">
                                <label for="registrofirmato" class="form-label">REGISTRO PRESENZE FIRMATO DIGITALMENTE</label>
                                <input type="file" class="form-control" name="registrofirmato" id="registrofirmato"
                                       accept="application/pkcs7-mime,application/pdf" onchange="return checkFileExtAndDim('pdf,p7m');" required>
                            </div>
                        ...
                        <form action="<%=request.getContextPath()%>/OperazioniMicro" method="POST" target="_blank" class="mt-3">
                            ...
                            <button type="submit" class="btn btn-success">
                                <i class="fa fa-file-download"></i> SCARICA REGISTRO FIRMATO DIGITALMENTE
                            </button>
                        </form>
                        <% }%>
                    </div>
