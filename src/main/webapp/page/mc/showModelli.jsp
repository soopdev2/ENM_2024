            ...
            <div class="container-fluid" id="kt_content">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="progress mb-3">
                            <div id="progressM3" class="progress-bar progress-bar-striped progress-bar-animated bg-success"
                        ...
                        if (temp != null) {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 text-center">
                                        <a href="javascript:void(0)" id="a_lez<%=lez.getLezione()%>"
                                           onclick="showLezioneDoubleM3(<%=lez.getId_cal1()%>,<%=lez.getId_cal2()%>, <%=lez.getLezione()%>)"
                                           class="btn-icon kt-font-io document lezioni">
                                    ...
                                    <div class="col-6 text-center">
                                        <a href="javascript:void(0)" id="a_lez<%=lez.getLezione()%>"
                                           onclick="showLezioneSingleM3(<%=lez.getId()%>, <%=lez.getLezione()%>)"
                                           class="btn-icon kt-font-io document lezioni">
                                            <i class="fa fa-file-invoice kt-font-io" style="font-size: 100px;"></i>
                                        </a>
                                    ...
                                    if (pl1 != null) {%>
                                        | <a href="calendar.jsp?idcalendar=<%=temp.getId()%>"
                            ...
                            <% if (noloaded) { %>
                            <h5 class="kt-font-io-n text-center">Ancora nessuna lezione caricata</h5>
                            <% }%>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5>
                            Modello 4
                            <% if (!m4.getStato().equalsIgnoreCase("S") && !m3.getStato().equalsIgnoreCase("OK")) { %>
                            - Gruppi
                            <i id="neet_excluded" style="display:none;" class="fa fa-exclamation-circle kt-font-warning"
                               data-bs-toggle="popover" data-bs-placement="bottom" title="NEET Esclusi"></i>
                            <% } %>
                        </h5>
                        <hr class="my-2">
                        ...
                        <!-- Progress -->
                        <div class="progress mb-3">
                            <div id="progressM4" class="progress-bar progress-bar-striped progress-bar-animated bg-success"
                                 role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"
                                 style="width: 0%"></div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control kt-select2 obbligatory" id="param_<%=i%>" name="param_<%=i%>" multiple="multiple"></select>
                            </div>
                            <% } %>
                        </div>
                        <br>
                        ...
                        <% if (!m4.getStato().equalsIgnoreCase("S")) { %>
                        <div class="mt-4" id="lezioni_m4" style="display:none;">
                        ...
                        noloaded = true;%>
                            <h5 class="kt-font-io">
                                <i class="fa fa-users kt-font-io"></i> Gruppo <%=i%>
                            </h5>
                            <div class="row g-3">
                            ...
                            if (Utility.lezioneFilteredByGroup(lezionim4, lez.getId(), i) != null) {
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-6">
                                    <div class="row">
                                        <% if (lez.isDoppia()) {%>
                                        <div class="col-6 text-center" id="msgItem_<%=lez.getLezione()%>_<%=i%>">
                                            <a href="javascript:void(0)" id="a_lez<%=lez.getLezione()%>_<%=i%>"
                                               onclick="showLezioneDoubleM4(<%=lez.getId_cal1()%>,<%=lez.getId_cal2()%>, <%=lez.getLezione()%>, <%=i%>)"
                                               class="btn-icon kt-font-io document gruppi">
                                                <i class="fa fa-file-invoice kt-font-io" style="font-size: 100px;"></i>
                                            </a>
                                        </div>
                                        <% } else {%>
                                        <div class="col-6 text-center" id="msgItem_<%=lez.getLezione()%>_<%=i%>">
                                            <a href="javascript:void(0)" id="a_lez<%=lez.getLezione()%>_<%=i%>"
                                               onclick="showLezioneSingleM4(<%=lez.getId()%>, <%=lez.getLezione()%>, <%=i%>)"
                                               class="btn-icon kt-font-io document gruppi">
                                                <i class="fa fa-file-invoice kt-font-io" style="font-size: 100px;"></i>
                                            </a>
                                        </div>
