...
<html>
    ...
    <body  class="d-flex flex-column min-vh-100">
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        ...
                        <div class="collapse show" id="collapseSearch">
                            <div class="card-body">
                                <form onsubmit="return ctrlForm();" accept-charset="ISO-8859-1" method="post">
        ...
        <script src="js/searchDocentiMicro.js" type="text/javascript"></script>
