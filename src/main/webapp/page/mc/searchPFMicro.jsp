                    ...
                    <div class="row kt-grid__item kt-grid__item--fluid">
                        <div class="col-12">
                            ...
                            <div class="card kt-portlet" id="kt_portlet" data-ktportlet="true">
                                <div class="card-header kt-portlet__head d-flex justify-content-between align-items-center">
                                    <h3 class="card-title kt-portlet__head-title">Cerca :</h3>
                                ...
                                <form action="" method="post" accept-charset="ISO-8859-1" class="kt-form kt-form--label-right" onsubmit="refresh();return false;">
                                    <div class="card-body kt-portlet__body pt-2 pb-2">
                                        <div class="row kt-section__body">
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <select class="form-select kt-select2-general" id="soggettoattuatore" name="soggettoattuatore">
                                                    ...
                                                    <option value="<%=i.getId()%>" <%= (i.getId() == idsa ? "selected" : "")%> >
                                                        <%=i.getRagionesociale()%>
                                                    </option>
                                                    <% }%>
                                                </select>
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="cip" id="cip" value="<%=StringEscapeUtils.escapeHtml4(icip)%>" autocomplete="off">
                                            </div>

                                            <!-- Stato -->
                                            <div class="col-lg-3 mb-3">
                                                <label class="active">Stato</label>
                                                <select class="form-select kt-select2-general" id="stato" name="stato">
                                                    <option value="-">Seleziona Stato</option>
                                                    <% for (StatiPrg i : stati) {%>
                                                    <option value="<%=i.getTipo()%>" <%= (istato.equals(i.getTipo()) ? "selected" : "")%> >
                                                        <%=i.getDescrizione()%>
                                                    </option>
                                                    <% }%>
                                                </select>
                                            ...
                                            <!-- Rendicontato -->
                                            <div class="col-lg-3 mb-3" id="rendicontato_filter" style="display: none;">
                                                <label>Rendic./Liq.:</label>
                                                <select class="form-select kt-select2-general obbligatory" id="rendicontato" name="rendicontato">
                                                    <option value="-">. . .</option>
                            ...
                            <!-- Risultati -->
                            <div class="row mt-3" id="offsetresult">
                                <div class="col-12">
                                    <div class="card kt-portlet" id="kt_portlet" data-ktportlet="true">
                                        ...
                                        <div class="card-body kt-portlet__body kt-scroll-x">
                                            <table class="table table-striped table-bordered" id="kt_table_1" style="border-collapse: collapse;" cellspacing="0">
                                                <thead>
