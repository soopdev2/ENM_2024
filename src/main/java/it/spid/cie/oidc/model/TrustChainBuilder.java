...
/**
 * A trust walker that fetches statements and evaluate the evaluables to create
 * a TrustChain object.
 *
 * @author Mauro Mariuzzo
 */
public class TrustChainBuilder implements Serializable {
...
//	}
    ...
    /**
     * @return return a chain of verified statements from the lower up to the
     * trust anchor
     * @throws OIDCException
     */
    ...
    /**
     * Ensure the provided Subject Entity Configuration is valid (self
     * validable) and complete (at least by required elements)
     *
     * @throws OIDCException
     * @throws OIDCException
     */
    ...
    /**
     * Ensure the provided TrustAnchor Entity Configuration is valid (self
     * validable) and complete (at least by required elements)
     *
     * @throws OIDCException
     */
