...
public class EntityConfiguration implements Serializable {
    ...
    /**
     * @param key
     * @return {@code true} if the {@code constraints} section inside
     * {@code payload} has an element named {@code key}
     */
    ...
    /**
     * @param kid
     * @return {@code true} if JWKSet of this entity contains a JWK with the
     * provided kid
     */
    ...
    /**
     * Validate the entity configuration only if marked by a well known trust
     * mark, issued by a trusted issuer
     *
     * @return
     * @throws OIDCException
     */
    ...
    /**
     * Validate this EntityConfiguration with the jwks contained in the
     ...
     * Validate the EntityConfiguration by itself
     *
     * @param silentMode when {@code false} Exceptions will be propagated to
     * caller
