...
/**
 * This class describes a "Federation Entity" (Federation Entity Configuration).
 * It represent the touch point between the starter kit and the final
 * application where this element have to be persisted into a database or
 * something similar.
 *
 * @author Mauro Mariuzzo
 */
@Entity
public class FederationEntity extends BaseModel implements Serializable {

    /**
     * URL that identifies this Entity in the Federation. Inside
     * {@link EntityConfiguration} this value will be used as {@code sub} and/or
     * {@code iss}.
     */
    @Id
