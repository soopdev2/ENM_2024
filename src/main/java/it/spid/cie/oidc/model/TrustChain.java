...
@Entity
public class TrustChain extends BaseModel implements Serializable {
    ...
    /**
     * @return the string representation of a JSONArray with the list of entity
     * statements collected during the metadata discovery
     */
    ...
    /**
     * @return the string representation of a JSONObject with the final metadata
     * applied with the metadata policy built over the chain
     */
