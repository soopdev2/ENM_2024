...
public class RelyingPartyHandler {
    ...
    /**
     * Build the "authorize url": the URL a RelyingParty have to send to an
     * OpenID Connect Provider to start a SPID/CIE authorization flow
     *
     * @param oidcProvider
     * @param trustAnchor
     * @param redirectUri
     * @param scope
     * @param profile {@code spid} or {@code cie}. If null or empty {@code spid}
     * will be used
     * @param prompt
     * @return
     * @throws OIDCException
    ...
    /**
     * Return the information needed to render the SignIn button with the OIDC
     * Providers configured into {@link RelyingPartyOptions}.<br/>
    ...
    /**
     * Return the "Well Known" information of the current Relying Party. The
     * completeness of these informations depends of the federation on-boarding
    ...
    //CODE:574f846d-41ae-31ea-8ab6-0ff285d3bab3 - STATE:AhGeTQNvM-4bMl0ND_GHpsVJS_1PzrtQvWO29gBI4YWe2vcMEkj9pqYAJOtIfZQV
